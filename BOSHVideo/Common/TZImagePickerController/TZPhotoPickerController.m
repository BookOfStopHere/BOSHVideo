...
//                         [weakself callDelegateMethodWithItem:item];
//                    }];
//                } else {
                     [weakself callDelegateMethodWithItem:item];
//                }
...
- (void)callDelegateMethodWithItem:(BOSHVideoItem *)item
{
    TZImagePickerController *imagePickerVc = (TZImagePickerController *)self.navigationController;
    if ([imagePickerVc.pickerDelegate respondsToSelector:@selector(imagePickerController:didFinishPickingMedia:)]) {
        [imagePickerVc.pickerDelegate imagePickerController:imagePickerVc didFinishPickingMedia:item];
    }
    if (imagePickerVc.didFinishPickingMediaHandle) {
        imagePickerVc.didFinishPickingMediaHandle(item);
    }
}
