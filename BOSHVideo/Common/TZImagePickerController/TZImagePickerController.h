...
//获取选择的视频
@property (nonatomic, copy) void (^didFinishPickingMediaHandle)(BOSHMediaItem *media);
...
//获取选择的视频
- (void)imagePickerController:(TZImagePickerController *)picker didFinishPickingMedia:(BOSHMediaItem *)media;
@end
